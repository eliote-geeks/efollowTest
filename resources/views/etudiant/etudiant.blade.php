                                        ...
                                        @foreach ($students as $s)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <span>
                                                        <button style="border: none; text-decoration: none; background: none;" type="button" data-bs-toggle="modal" data-bs-target="#editStudentModal{{ $s->id }}">
                                            ...
                                            <!-- Edit Student Modal -->
                                            <div class="modal fade" id="editStudentModal{{ $s->id }}" tabindex="-1" aria-labelledby="editStudentModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ route('etudiant.update', $s->id) }}" method="POST">
                                                                @csrf
                                                                @method('PUT')
                                                                <div class="row mb-3">
                                                                    <label for="profile-image" class="d-block">
                                                                        <img id="profile-image-preview" src="{{ \App\Models\User::findOrFail($s->user_id)->profile_photo_url }}" style="height: 100px; width: 100px;" class="img-thumbnail" style="cursor: pointer;">
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="editStudentName" class="form-label">Nom complet</label>
                                                                    <input type="text" class="form-control" id="editStudentName" name="name" placeholder="Entrez le nom complet de l'étudiant" value="{{ $s->firstName }}" required>
                                                                </div>
                                                                <div class="mb-3">
                                                                    <label for="editStudentBirthday" class="form-label">Date de naissance</label>
                                                                    <input type="date" class="form-control" id="editStudentBirthday" name="birth_date" value="{{ $s->birth_date }}" required>
                                                                </div>
                                                                <div class="mb-3">
                                                                    <label for="editStudentMatricule" class="form-label">Matricule</label>
                                                                    <input type="text" class="form-control" id="editStudentMatricule" name="matricular" placeholder="Entrez le matricule de l'étudiant" value="{{ $s->matricular }}" required>
                                                                </div>
                                                                <div class="mb-3">
                                                                    <label for="specialityName" class="form-label">Spécialité</label>
                                                                    <select class="form-select" id="specialityName1" name="specialityName" required>
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select class="form-select" id="levelName1" name="niveau" required>
                                            ...
                                            <div class="modal fade" id="deleteStudentModal{{ $s->id }}" tabindex="-1" aria-labelledby="deleteStudentModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form action="{{ route('etudiant.destroy', $s) }}" method="POST">
                                                                    @csrf
                                                                    @method('DELETE') 
                            ...
                            <div class="tab-pane fade show active profile-overview" id="addInfos">
                                <form action="{{ route('etudiant.store') }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="studentName" name="name" placeholder="Entrez le nom complet de l'étudiant" required>
                                        @error('name')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" id="studentBirthday" name="birth_date" required>
                                        @error('birth_date')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
