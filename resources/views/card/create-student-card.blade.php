    ...
    <div class="container">
        <div class="centered-div">
            <div class="text-center">
                <form action="{{ route('addPostStudentCard', $student) }}" method="POST">
                    @csrf
                    <center>
                    ...
                    <h1 class="fw-bold text-black text-center mt-3">APPROCHEZ LA CARTE DE L'ÉTUDIANT POUR CRÉER SON COMPTE</h1>
